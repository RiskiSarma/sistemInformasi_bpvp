...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6 hover:shadow-md transition">
            ...
            <!-- Grid 2x2 untuk 4 button -->
            <div class="grid grid-cols-2 gap-2 pt-4 border-t">
                <a href="{{ route('admin.instructors.show', $instructor) }}" 
                   class="px-3 py-2 text-center border rounded-lg hover:bg-gray-50 transition text-sm flex items-center justify-center space-x-1">
                ...
                <a href="{{ route('admin.instructors.schedule', $instructor) }}" 
                   class="px-3 py-2 text-center border border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition text-sm flex items-center justify-center space-x-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.instructors.attendance', $instructor) }}" 
                   class="px-3 py-2 text-center border border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition text-sm flex items-center justify-center space-x-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.instructors.edit', $instructor) }}" 
                   class="px-3 py-2 text-center bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-sm flex items-center justify-center space-x-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
