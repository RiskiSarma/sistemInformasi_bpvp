...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Tambah Pengajar Eksternal</h2>

        <form method="POST" action="{{ route('admin.pengajar-eksternal.store') }}" class="space-y-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="nipi" 
                               value="{{ old('nipi') }}"
                               class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('nipi') border-red-500 @enderror">
                        @error('nipi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" 
                               name="jabatan" 
                               value="{{ old('jabatan') }}"
                               placeholder="Contoh: Dosen, Praktisi Industri"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat" 
                                  rows="3"
                                  class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('alamat') border-red-500 @enderror">{{ old('alamat') }}</textarea>
                        @error('alamat')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
