...
<head>
    ...
    <!-- Flowbite (opsional, kalau dipakai) -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.3.0/flowbite.min.js"></script>

    <!-- jQuery – HARUS DULUAN sebelum Select2 dan library lain yang butuh jQuery -->
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto" 
                x-data="{ 
                    programOpen: {{ 
                        ...
                        request()->routeIs('admin.jenis-materi-pelatihan.*')   ||            // unit kompetensi independen        // unit kompetensi independen
                        request()->routeIs('admin.programs.jenis-pelatihan.*') ||
                        request()->routeIs('admin.programs.paket-pelatihan.*') ||
                        request()->routeIs('admin.programs.kejuruan-bidang.*')
                        ? 'true' : 'false' 
                    }},
                    pengajarOpen: {{
                        request()->routeIs('admin.instructors.*') ||
                        request()->routeIs('admin.pengajar-eksternal.*')
                        ? 'true' : 'false'
                    }}
                }">
                ...
                <div>
                    ...
                    <div x-show="programOpen" x-collapse class="mt-2 space-y-1 pl-4">
                        ...
                        <a href="{{ route('admin.jenis-materi-pelatihan.index') }}" 
                ...
                <div>
                    <button @click="pengajarOpen = !pengajarOpen" 
                        ...
                        <svg class="w-4 h-4 transition-transform" :class="pengajarOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>

                    <div x-show="pengajarOpen" x-collapse class="mt-2 space-y-1 pl-4">
                        <a href="{{ route('admin.instructors.index') }}" 
                        class="block px-4 py-2 text-sm rounded-lg transition {{ request()->routeIs('admin.instructors.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100' }}">
                            Instruktur (Internal)
                        </a>
                        
                        <!-- ✅ BARU: PENGAJAR EKSTERNAL -->
                        <a href="{{ route('admin.pengajar-eksternal.index') }}" 
                        class="block px-4 py-2 text-sm rounded-lg transition {{ request()->routeIs('admin.pengajar-eksternal.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100' }}">
                            Pengajar Eksternal
                        </a>
                    </div>
                </div>
                ...
                <a href="{{ route('admin.users.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.users.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                    </svg>
