    ...
    <div class="min-h-screen flex">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                @foreach([
                    ['route' => 'participant.dashboard',        'pattern' => 'participant.dashboard',        'icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', 'label' => 'Dashboard'],
                    ['route' => 'participant.program',          'pattern' => 'participant.program',          'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', 'label' => 'Program Saya'],
                    ['route' => 'participant.attendance',       'pattern' => 'participant.attendance',       'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', 'label' => 'Kehadiran'],
                    ['route' => 'participant.certificate.index','pattern' => 'participant.certificate.*',    'icon' => 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z', 'label' => 'Sertifikat'],
                    ['route' => 'participant.profile.edit',     'pattern' => 'participant.profile.*',        'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'label' => 'Profil Saya'],
                ] as $item)
                ...
                {{-- Daftar Ulang with badge --}}
                <a href="{{ route('participant.daftar-ulang.index') }}"
                   class="{{ $navBase }} {{ request()->routeIs('participant.daftar-ulang.*') ? $navActive : $navInactive }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @endphp
                    @if($belumUpload > 0)
                        <span class="ml-auto text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full
                                     {{ request()->routeIs('participant.daftar-ulang.*') ? 'bg-white text-teal-600' : 'bg-red-500 text-white' }}">
                            {{ $belumUpload }}
                        </span>
                    @endif
                </a>
            ...
            <header class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm fixed top-0 right-0 left-0 lg:left-64 z-30">
                <div class="flex items-center justify-between h-16 px-6">
                    ...
                    <div class="flex-1 lg:flex-none">
                        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">@yield('title', 'Dashboard Peserta')</h2>
                    </div>
                        ...
                        <div class="hidden md:block relative" x-data="{ profileOpen: false }">
                            <button @click="profileOpen = !profileOpen" class="flex items-center space-x-3 pl-3 border-l border-gray-200 dark:border-gray-700">
                                <div class="text-right hidden lg:block">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Peserta</p>
                                </div>
                            ...
                            <div x-show="profileOpen" @click.away="profileOpen = false"
                                ...
                                <a href="{{ route('participant.profile.edit') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800">
