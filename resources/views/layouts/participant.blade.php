        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                <a href="{{ route('participant.dashboard') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('participant.dashboard') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                ...
                <a href="{{ route('participant.program') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('participant.program') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('participant.attendance') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('participant.attendance') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('participant.profile.edit') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('participant.profile.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white shadow-sm border-b fixed top-0 right-0 left-0 lg:left-64 z-30">
                <div class="flex items-center justify-between h-16 px-6">
                    ...
                    <div class="flex-1 lg:flex-none">
                        <h2 class="text-xl font-semibold text-gray-800">@yield('title', 'Dashboard Peserta')</h2>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:block relative" x-data="{ profileOpen: false }">
                            ...
                            <div x-show="profileOpen" @click.away="profileOpen = false" 
                                ...
                                <a href="{{ route('participant.profile.edit') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
