    ...
    <div class="min-h-screen flex">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto" 
                 x-data="{ programOpen: {{ request()->routeIs('admin.programs.*') ? 'true' : 'false' }} }">
                
                <a href="{{ route('admin.dashboard') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.dashboard') ? 'text-white bg-blue-600' : 'text-gray-700 hover:bg-gray-100' }}">
                ...
                <div>
                    <button @click="programOpen = !programOpen" 
                            class="w-full flex items-center justify-between px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition">
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="programOpen" x-collapse class="ml-4 mt-2 space-y-1">
                        <a href="{{ route('admin.programs.index') }}" 
                           class="flex items-center space-x-3 px-4 py-2 text-sm rounded-lg transition {{ request()->routeIs('admin.programs.index') || request()->routeIs('admin.programs.create') || request()->routeIs('admin.programs.edit') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-100' }}">
                            <span>Kelola Pelatihan</span>
                        </a>
                        <a href="{{ route('admin.programs.master') }}" 
                           class="flex items-center space-x-3 px-4 py-2 text-sm rounded-lg transition {{ request()->routeIs('admin.programs.master') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-100' }}">
                            <span>Program Pelatihan (Master)</span>
                        </a>
                        <a href="{{ route('admin.programs.units') }}" 
                           class="flex items-center space-x-3 px-4 py-2 text-sm rounded-lg transition {{ request()->routeIs('admin.programs.units') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-100' }}">
                ...
                <a href="{{ route('admin.participants.index') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.participants.*') ? 'text-white bg-blue-600' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.instructors.index') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.instructors.*') ? 'text-white bg-blue-600' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.attendance.index') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.attendance.*') ? 'text-white bg-blue-600' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.reports.index') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.reports.*') ? 'text-white bg-blue-600' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.certificates.index') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.certificates.*') ? 'text-white bg-blue-600' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
